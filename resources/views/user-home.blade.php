...
@section('content')
    <div class="search-bar-section">
        <form action="#" class="search-bar-section">
                    ...
                    <div class="col">
                        <div class="service-center-individual">
                            ...
                            <div class="service-center-description">
                                ...
                                <br>
                                <a href="{{route('user.service_center_profile',[$customer->id,$service_center->id])}}"><button type="button" class="btn-primary">View Profile</button></a>
