...
<nav class="navbar navbar-inverse bg-inverse navbar-toggleable-md">
    <div class="container">
        <a class="navbar-brand" href="{{route('user.home',$customer->id)}}"><img src="{{asset('User_Frontend/user_login/images/ClockWerkNepalLogo.png')}}" style="height: 150px; width: 240px" alt=""></a>
