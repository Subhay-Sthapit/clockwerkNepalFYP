...
<header class="site-header bg-white shadow-sm">
    <div class="container">
        <div class="d-flex flex-wrap justify-content-between py-3">
            <a class="navbar-brand" href="{{route('user.home',$customer->id)}}"><img src="{{asset('img/clockwreknepal.png')}}" alt="ClockWrek Nepal"
                                                                                     title="Clockwerk Nepal"></a>
            {{--nav bar section--}}
            <nav class="navbar navbar-toggleable-md">
                <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarsExampleCenteredNav"
                        ria-controls="navbarsExampleCenteredNav" aria-expanded="false" aria-label="Toggle navigation">
