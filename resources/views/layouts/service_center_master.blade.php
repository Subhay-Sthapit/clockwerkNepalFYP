    ...
    <header class="site-header bg-white shadow-sm">
        <div class="container">
            <div class="d-flex flex-wrap justify-content-between py-3">
                <a class="navbar-brand" href="{{route('service-center.home',$service_center->id)}}"><img
                        src="{{asset('img/clockwreknepal.png')}}" alt="ClockWrek Nepal" title="Clockwerk Nepal"></a>
                {{--nav bar section--}}
                <nav class="navbar navbar-toggleable-md">
                    <div class="container">
                        <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse"
                                data-target="#navbarsExampleCenteredNav" aria-controls="navbarsExampleCenteredNav" aria-expanded="false"
...
<script src="{{asset('Service_Center_Frontend/service_center_profile.js')}}"></script>
