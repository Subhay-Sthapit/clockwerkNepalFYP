...
<nav class="navbar navbar-inverse bg-inverse navbar-toggleable-md">
    <div class="container">
        <a class="navbar-brand" href="{{route('service-center.home',$service_center->id)}}"><img src="{{asset('User_Frontend/user_login/images/ClockWerkNepalLogo.png')}}" style="height: 150px; width: 240px" alt=""></a>
        ...
        <div class="collapse navbar-collapse navbar-collapse justify-content-md-end" id="navbarsExampleCenteredNav" style="margin-top: -12px">
            <ul class="navbar-nav">
                <li class="nav-item">
